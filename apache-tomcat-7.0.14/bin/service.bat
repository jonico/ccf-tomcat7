...
set "EXECUTABLE=%CATALINA_HOME%\bin\tomcat7%PROCESSOR_ARCHITECTURE%.exe"
...
set PR_DESCRIPTION=Apache Tomcat 7.0.14 Server - http://tomcat.apache.org/
...
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-XX:+CMSClassUnloadingEnabled"
